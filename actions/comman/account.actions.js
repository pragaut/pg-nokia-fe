import * as accountTypes from '../../action-types/comman/account.action.types'
...
import * as windowTypes from '../../action-types/comman/window.action.types';
import { LOGIN_SUCCESS } from '../../action-types/comman/account.action.types';

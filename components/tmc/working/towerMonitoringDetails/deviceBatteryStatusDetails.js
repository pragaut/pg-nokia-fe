...
class DeviceBatteryStatusDetails extends Wrapper {
    ...
    render() {
        ...
        console.log(singleData && (singleData.child1DeviceBattery && parseInt(singleData.child1DeviceBattery) === 100 || singleData.child1DeviceBattery == '100')?"Child 1 ":"no child 1");
        return (
            <CommonStyle.MainDiv
                padding="10px 0px"

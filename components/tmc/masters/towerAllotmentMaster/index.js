...
import { getTowerAllotmentMasterData, saveTowerAllotmentMasterData, getTowerAllotmentMasterDataById, deleteTowerAllotmentMasterData } from '../../../../actions/tmc/admin.action';
import ListTable from '../../../shared/ListTable';
import TowerAllotmentAddEdit from './towerAllotment.add.edit';
import * as CommonStyle from '../../../comman/commonStyle';
import TowerAllotmentMasterDetails from '../../../comman/ReactTableComponent';
...
const mapStateToProps = state => {
    const { towerAllotment, towerAllotments, towerAllotmentRecordsCount, towerAllotmentActiontype } = state.adminReducerTmc; 

...
import { getPendingTaskDashBoardData } from '../../actions/working.action';
...
class index extends Wrapper {
    ...
    componentDidMount() {
        this.props.getPendingTaskDashBoardData(0, constants.DEFAULT_ROWS_LIST, undefined, undefined);
...
export default withRouter(connect(mapStatetoProps, { getPendingTaskDashBoardData, processFlowSelection })(index));

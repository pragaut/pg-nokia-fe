...
const config = {
    url: 'https://anandgroupindia.com',
    URL: process.env.OLD_SHOPPING_URL,
    SHOP_URL: process.env.SHOPPING_URL,
   ...
   // RECONCILIATION_URL: process.env.RECONCILIATION_URL,
    ...
    //track_url: 'http://tracking.thebigstack.com/'
    track_url: 'https://shiprocket.co/tracking/',

    /**
     * You are now eligible for our Buy 2 Get 1 offer. Add 1 more item and get 1 at Rs.0!
     */
};
